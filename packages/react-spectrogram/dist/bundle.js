(function (factory) {
	...
	*/
	...
	const FrequencyRuler = ({ width, height, minFrequency, maxFrequency, color = "#000", backgroundColor, dividers = true, orientation = 'vertical', position = 'inset', direction = 'descending', x, y, selfContained = true, }) => {
	    ...
	    return (React.createElement(WrapperComponent, { transform: `translate(${x}, ${y})`, width: width },
	        ...
	        labels.map(({ label, position: freqPosition, labelIsVisible }, i) => (React.createElement("g", { key: label, transform: orientation === 'vertical' ? `translate(0, ${freqPosition})` : `translate(${freqPosition}, 0)` },
	...
	const TimeRuler = ({ width, height, timeWindow, currentTime, color = "#000", backgroundColor, dividers = true, measuredBy = 'Time', orientation = 'horizontal', position = 'inset', x, y, selfContained = true, }) => {
	    const labels = react.exports.useMemo(() => {
	    ...
	    return (React.createElement(WrapperComponent, { transform: `translate(${x}, ${y})`, width: width },
	        ...
	        dividers && orientation === 'vertical' && (React.createElement(React.Fragment, null,
	            ...
	            React.createElement("line", { x1: width, y1: 0, x2: width, y2: height, stroke: color, strokeWidth: 1 }))),
	        backgroundColor && (React.createElement("rect", { x: 0, y: 0, width: width, height: height, fill: backgroundColor })),
	        orientation === 'horizontal' && labels.map((timeStep, i) => (React.createElement("g", { key: timeStep, transform: `translate(${width * getRenderPointFromTime(currentTime, timeWindow, startTime + timeStep)}, 0)` },
	        ...
	        orientation === 'vertical' && labels.map((timeStep, i) => (React.createElement("g", { key: timeStep, transform: `translate(0, ${height * getRenderPointFromTime(currentTime, timeWindow, startTime + timeStep)})` },
	...
	const pointersToGestureEvent = (pointers) => {
	...
	const useGestures = (ref, { onPanMove, onPanStart, onPanEnd, onPinchMove, onPinchStart, onPinchEnd, onWheel, }) => {
	    const pointersRef = react.exports.useRef({});
	...
	const useKey = (keyCode) => {
	    const [isPressed, setIsPressed] = react.exports.useState(false);
	    react.exports.useEffect(() => {
	...
	var bundle_browser = {exports: {}};

	(function (module, exports) {
	(function (global, factory) {
	  factory(exports) ;
	})(commonjsGlobal, (function (exports) {
	  var processor = "";
	...
	}(bundle_browser, bundle_browser.exports));
	...
	document.querySelector('#timeoffsetdisplay');
	...
	class SpectrogramRenderer {
	    ...
	    constructor({ canvas, advancedAnalyserNode, 
	    // audioContext,
	    audioSource, data, isDataHandledExternally = false, currentTime = 0, }) {
	    ...
	    async initAaNode() {
	        this._aaNode = this._aaNode || await bundle_browser.exports.createAdvancedAnalyserNode(this._audioContext, {
	            // fftSize: 1024, 
	...
	const useSpectrogramRenderer = ({ canvas, audioSource, isDataHandledExternally, advancedAnalyserNode, data, currentTime, }) => {
	    const [spectrogramRenderer, setSpectrogramRenderer] = react.exports.useState(null);
	    react.exports.useEffect(() => {
	...
	const drag = (timeWindow, startTime, timeAxisSize, frequencyAxisSize, minFrequency, maxFrequency, deltaX, deltaY) => {
	    const timePerPixel = (timeWindow / timeAxisSize);
	    let newMinFrequency = lerpLog(minFrequency, maxFrequency, deltaY / frequencyAxisSize);
	    let newMaxFrequency = lerpLog(minFrequency, maxFrequency, (frequencyAxisSize + deltaY) / frequencyAxisSize);
	...
	const scaleTimeWindow = (timeWindow, currentTime, scaleFactor, origin) => {
	    if ((timeWindow <= 1000 && scaleFactor < 1)
	    ...
	    const newTimeWindow = clamp$1(timeWindow * scaleFactor, 1000, 3600_000);
	...
	const scaleFrequencies = (minFrequency, maxFrequency, scaleFactor, origin) => {
	    ...
	    return {
	        minFrequency: clamp$1(newMinFrequency, 20, 44100),
	        maxFrequency: clamp$1(newMaxFrequency, 20, 44100),
	    };
	};
	const Spectrogram = ({ width, height, minFrequency, maxFrequency, timeWindow, currentTime, audioSource, dynamicRange, dynamicRangeTop, onMaxFrequencyChange, onMinFrequencyChange, onTimeWindowChange, onCurrentTimeChange, modifierKeyCode = 'ShiftLeft', ...props }) => {
	    ...
	    const { setMinFrequency, setMaxFrequency, setTimeWindow, setCurrentTime, setDynamicRange, setDynamicRangeTop, } = useSpectrogramRenderer({
	        canvas: canvasRef,
	        audioSource,
	    });
	    ...
	    useAnimationFrame(() => {
	        if (activePanEvent && activePanEvent.releaseTime) {
	            ...
	            const { minFrequency, maxFrequency, currentTime } = drag(timeWindow, startTime, width, height, startFrequencies.min, startFrequencies.max, releaseDeltaPosition.x + newDeltaPosition.x, releaseDeltaPosition.y + newDeltaPosition.y);
	    ...
	    useGestures(canvasRef, {
	        ...
	        onPinchMove: (e) => {
	            ...
	            const updatedPos = drag(startTimeWindow, startTime, width, height, min, max, e.deltaX, e.deltaY);
	            const updatedTime = scaleTimeWindow(startTimeWindow, updatedPos.currentTime, Math.abs(Math.max(e.pinchStartMagnitudeX, 40)
	                /
	                    Math.max(e.pinchMagnitudeX, 40)), e.relativeX / width);
	            const updatedFrequencies = scaleFrequencies(updatedPos.minFrequency, updatedPos.maxFrequency, Math.abs(Math.max(e.pinchStartMagnitudeY, 40)
	                /
	                    Math.max(e.pinchMagnitudeY, 40)), e.relativeY / height);
	        ...
	        onPanMove: (e) => {
	            if (activePanEvent) {
	                ...
	                const updated = drag(timeWindow, startTime, width, height, min, max, e.x - e.startX, e.y - e.startY);
	        ...
	        onWheel: (e) => {
	            ...
	            if (!modifierIsPressed) {
	                ...
	                const updatedFrequencies = scaleFrequencies(minFrequency, maxFrequency, delta, e.relativeY / height);
	                onMinFrequencyChange(updatedFrequencies.minFrequency);
	                onMaxFrequencyChange(updatedFrequencies.maxFrequency);
	            }
	            else {
	                const delta = (height + (e.deltaWheel * -1)) / height;
	                const updated = scaleTimeWindow(timeWindow, currentTime, delta, e.relativeX / width);
	    ...
	    return (React.createElement(React.Fragment, null,
	        React.createElement("div", { style: {
	            ...
	            React.createElement("svg", { width: width, height: height, style: {
	                    position: 'absolute',
	                    height: '100%',
	                    width: '100%',
	                    top: 0,
	                ...
	                React.createElement(FrequencyRuler, { width: 40, height: height, minFrequency: minFrequency, maxFrequency: maxFrequency, x: 0, y: 0, color: '#fff', position: 'inset', selfContained: false }),
	                React.createElement(TimeRuler, { width: width, height: 30, timeWindow: timeWindow, currentTime: currentTime, position: 'inset', x: 0, y: height - 30, selfContained: false, color: "#fff" })),
	        ...
	        timeWindow,
	        React.createElement("br", null),
	        JSON.stringify(activePanEvent, null, 2),
	        React.createElement("br", null),
	        currentTime,
	        React.createElement("br", null)));
	};

	const useAsyncMemo = (asyncFn, deps) => {
	...
	const App = () => {
	    ...
	    const [audioContext, setAudioContext] = react.exports.useState(null);
	    const audioSource = useAsyncMemo(async () => {
	        if (!audioContext)
	            return;
	    ...
	    return (React.createElement("div", null,
	        audioSource && (React.createElement(Spectrogram, { width: 512, height: 512, minFrequency: minFrequency, maxFrequency: maxFrequency, timeWindow: timeWindow, currentTime: currentTime, onMaxFrequencyChange: setMaxFrequency, onMinFrequencyChange: setMinFrequency, onTimeWindowChange: setTimeWindow, onCurrentTimeChange: setCurrentTime, audioSource: audioSource, dynamicRange: dynamicRange, dynamicRangeTop: dynamicRangeTop, onDynamicRangeChange: setDynamicRange, onDynamicRangeTopChange: setDynamicRangeTop })),
