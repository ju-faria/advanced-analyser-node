	...
	*/
	...
	const App = () => {
	    ...
	    return (React.createElement("div", null,
	        dataResolver && (React.createElement(Spectrogram, { width: width, height: height - 20, 
	            // minFrequency={minFrequency}
	            // maxFrequency={maxFrequency}
	            // timeWindow={timeWindow}
	            // currentTime={currentTime}
	            transforms: spectrogramTransforms, onChange: setSpectrogramTransforms, 
	            // onMaxFrequencyChange={setMaxFrequency}
	            // onMinFrequencyChange={setMinFrequency}
	            // onTimeWindowChange={setTimeWindow}
	            // onCurrentTimeChange={setCurrentTime}
	            dynamicRange: dynamicRange, dynamicRangeTop: dynamicRangeTop, onDynamicRangeChange: setDynamicRange, onDynamicRangeTopChange: setDynamicRangeTop, dataResolver: dataResolver, timeRulerAsOverlay: false, frequencyRulerAsOverlay: false, frequencyRulerPosition: frequencyRulerPosition, timeRulerPosition: timeRulerPosition, frequencyScale: frequencyScale },
